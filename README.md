...
to be modified. See [Configuration](#7-configuration) section. Also, you are strongly
...
As explained in the [Quickstart](#6-quickstart) section, before running scos-sensor, an
