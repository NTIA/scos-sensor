...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('frequency', models.FloatField(help_text=b'Frequency at which scale factor was computed. [Hz]')),
                ('scale_factor', models.FloatField(help_text=b'Real multiplicative voltage scaling factor.')),
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scale_factors', to='capabilities.Receiver')),
            ],
        ),
        migrations.CreateModel(
