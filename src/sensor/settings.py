...
# If present and parseable, gain and noise figure values will be used in
# place of any present in the SENSOR_CALIBRATION_FILE.
ONBOARD_CALIBRATION_FILE = path.join(CONFIG_DIR, "onboard_sensor_calibration.json")
...
os.environ["SENSOR_CALIBRATION_FILE"] = sensor_cal_path
...
os.environ["DIFFERENTIAL_CALIBRATION_FILE"] = diff_cal_path
...
CALIBRATION_EXPIRATION_LIMIT = env("CALIBRATION_EXPIRATION_LIMIT")
