...
@pytest.mark.parametrize(
    ...
    [
        ...
        (7.50256094609, 7e9, 0),
        (2.521869535, 70e6, -10), #-7.47813046479
        (-100.2557869767, 70e6, 100), #-76.2557869767
        # At division
        (-5.40071178476, 1299974999, 0),
        (-5.41274003389, 1300974999, 0),
        (10.665475613929, 2199469999, -10), #0.665475613929
        (-100.3832149678, 2200468999, 100), #-76.3832149678
        (15.81812380813, 3999124997, -10), #5.81812380813
        (-93.7131434755, 4000123997, 100), #-69.7131434755
        # In division
...
def test_scale_factor_calculation(sf, f, g):
    ...
    sf = int(1e5 * sf)
    csf = int(1e5 * cal.get_power_scale_factor(1, f, g))
