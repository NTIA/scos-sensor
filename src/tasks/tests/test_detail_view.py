...
def test_user_cant_delete_others_results(
    ...
    admin_result_name = simulate_acquisitions(admin_client, name="admin_single_acq")
...
def test_user_cant_modify_others_results(
    ...
    # admin user schedule entry
    admin_entry_name = simulate_acquisitions(admin_client, name="admin_single_acq")
...
def test_admin_can_view_all_results(
    ...
    # user schedule entry
    user_result_name = simulate_acquisitions(user_client, name="admin_single_acq")
...
def test_admin_can_view_private_results(admin_client, alt_admin_client, test_scheduler):
    private_entry_name = simulate_acquisitions(alt_admin_client, is_private=True)
    private_result_url = reverse_result_detail(private_entry_name, 1)
