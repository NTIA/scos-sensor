...
import logging
from scos_actions.actions.interfaces.signals import location_action_completed, measurement_action_completed
...
class HandlersConfig(AppConfig):
    ...
    def ready(self):
        ...
        logger.debug("measurement_action_completed_callback registered to measurement_action_completed")
        location_action_completed.connect(location_action_completed_callback)
        logger.debug("location_action_completed_callback registered to location_action_completed")